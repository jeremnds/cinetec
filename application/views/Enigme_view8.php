...
?>
  <style>
      body{
       background-image: url('assets/img/enigme_8.jpg');
      }
    </style>
<body class="">
   
   <img src="assets/img/pellicule8.png" alt="" class="col-md-12" id="pellicule">
        ...
        <h1>Enigme 8</h1>
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="col-md-4 col-xs-12 indice">
                   <h2>INDICE 1</h2>
                   Le premier des plus grands
                
                </div>
                <div class="col-md-4 col-xs-12 indice">
                   <h2>INDICE 2</h2>
                  Mon premier est l’ennemi préféré des dents.
                </div>
                <div class="col-md-4 col-xs-12 indice">
                   <h2>INDICE 3</h2>
                   <img src="assets/img/rebus8.png" alt="" class="col-md-12 img-responsive">
